...
--
-- Host: 127.0.0.1    Database: readium_lcp_server
-- ------------------------------------------------------
...
CREATE TABLE `license` (
  ...
  `content_fk` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `lsd_status` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `content_fk` (`content_fk`),
  CONSTRAINT `license_ibfk_1` FOREIGN KEY (`content_fk`) REFERENCES `content` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-01-04 17:05:35
